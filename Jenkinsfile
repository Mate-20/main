pipeline {
    ...
    stages {
        ...
        stage('build') {
            steps {
                bat "C:\\.Net&JavaSoftware\\apache-maven-3.6.3-bin\\apache-maven-3.6.3\\bin\\mvn.cmd -f Spring Boot Backend/AdvanceJavaFive/LibraryMangBackend/pom.xml clean package"
            }
        }
    }
}
