pipeline {
    ...
    stages {
        ...
        stage('build') {
            steps {
               bat "\"C:\\Windows\\System32\\cmd.exe\" /C \"C:\\.Net&JavaSoftware\\apache-maven-3.6.3-bin\\apache-maven-3.6.3\\bin\\mvn.cmd\" -f AdvanceJavaFive/LibraryMangBackend/pom.xml clean package"
            }
        }
    }
}
